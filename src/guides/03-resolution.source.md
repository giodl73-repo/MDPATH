...
```proof:row source=md://src/data/label-matching.md foreach=row separator=" │ "
proof:element kind=label field=priority width=4
proof:element kind=badge field=strategy width=18
proof:element kind=label field=example-label width=26
proof:element kind=label field=example-query width=20
proof:element kind=label field=matches width=16
```
